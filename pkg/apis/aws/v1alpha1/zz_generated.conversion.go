...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*FlowState)(nil), (*aws.FlowState)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_FlowState_To_aws_FlowState(a.(*FlowState), b.(*aws.FlowState), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.FlowState)(nil), (*FlowState)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_FlowState_To_v1alpha1_FlowState(a.(*aws.FlowState), b.(*FlowState), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_FlowState_To_aws_FlowState is an autogenerated conversion function.
func Convert_v1alpha1_FlowState_To_aws_FlowState(in *FlowState, out *aws.FlowState, s conversion.Scope) error {
	return autoConvert_v1alpha1_FlowState_To_aws_FlowState(in, out, s)
}
...
// Convert_aws_FlowState_To_v1alpha1_FlowState is an autogenerated conversion function.
func Convert_aws_FlowState_To_v1alpha1_FlowState(in *aws.FlowState, out *FlowState, s conversion.Scope) error {
	return autoConvert_aws_FlowState_To_v1alpha1_FlowState(in, out, s)
}
...
func autoConvert_v1alpha1_InfrastructureStatus_To_aws_InfrastructureStatus(in *InfrastructureStatus, out *aws.InfrastructureStatus, s conversion.Scope) error {
	...
	out.FlowState = (*aws.FlowState)(unsafe.Pointer(in.FlowState))
	return nil
}
...
func autoConvert_aws_InfrastructureStatus_To_v1alpha1_InfrastructureStatus(in *aws.InfrastructureStatus, out *InfrastructureStatus, s conversion.Scope) error {
	...
	out.FlowState = (*FlowState)(unsafe.Pointer(in.FlowState))
	return nil
}
