...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlowState) DeepCopyInto(out *FlowState) {
	*out = *in
	...
	if in.CompletedTaskMarkers != nil {
		in, out := &in.CompletedTaskMarkers, &out.CompletedTaskMarkers
		*out = make(map[string]bool, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlowState.
func (in *FlowState) DeepCopy() *FlowState {
	if in == nil {
		return nil
	}
	out := new(FlowState)
